...
void gl::GlFrameBuffer::BindRenderBuffer(gl::FrameBufferAttachment target, unsigned renderBuffer)
{
    gl::framebuffer::setRenderbuffer(frameBuffer, integral(target), renderBuffer);
}
